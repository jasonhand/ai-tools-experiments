...
Right now I have a summary. What happened? I have accomplishments as a list, terminal commands that were run. I'm gonna make it so it's not just all get commands, that's boring. Discussion notes from chat, and then it's, I wanted to tell you tone and mood. So this these sample ones aren't.
...
And then gathering all that source information and then using it to make this. But then in one day there are a lot of these. Then on the first commit of the next day, it'll automatically trigger a summary of the day before.

[00:18:43] **Jason Hand:** Oh, wow. 

[00:18:43] **Whitney Lee:** And then on the first commit of the next week, it'll automatically trigger a summary of your past week and similar monthly, weekly, yearly.
...
We got it. But what's interesting is like writing a function to to get the summary.
...
Even now I don't know, I guess I would have to experiment, experiment with Codex, but I can't imagine now that we're getting into the logic of what should go in a journal summary, what would AI make up for that? That [00:27:00] just feels like it's very human or 
